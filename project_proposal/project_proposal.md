...
## Dataset
The main dataset will be the IVV table “Evolução da Produção Total por Região Vitivinícola”, available at https://www.ivv.gov.pt/np4/163.html. This dataset contains annual wine production values by viticultural region in hectoliters and will be collected directly from the IVV statistics portal, which is the official public source for these records in Portugal. If data integration is straightforward, the project may also use the IVV series “Evolução da Área Total de Vinha - Portugal”, available at https://www.ivv.gov.pt/np4/10586.html, as an additional explanatory variable.
